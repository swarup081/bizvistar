        ...
        <LegalLayout title="BizVistar Terms of Service" lastUpdated={new Date().toLocaleDateString('en-IN', { year: 'numeric', month: 'long', day: 'numeric' })}>
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">1.1. Our Purpose</h3>
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">1.2. Legal Agreement</h3>
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">2.1. Age Requirements</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">2.2. Minor Prohibition</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">2.3. Sanctions and Location</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">3.1. Account Creation</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">3.2. Account Security</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">3.3. Account Ownership</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">4.1. General Compliance</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">4.2. Prohibited Actions</h3>
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">4.3. Enforcement</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">5.1. Your Intellectual Property</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">5.2. License to BizVistar</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">5.3. BizVistar&apos;s Intellectual Property</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">6.1. E-Commerce Features</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">6.2. Your Responsibility</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">6.3. Payments and UPI</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">6.4. Taxes and Fulfilment</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">7.1. Paid Services</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">7.2. Strictly Non-Refundable</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">7.3. Auto-Renewals</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">7.4. Chargebacks</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">8.1. AI Integrations</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">8.2. Input and Output</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">8.3. Data Sharing</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">9.1. Third-Party Engagement</h3>
                  <p className="text-gray-700 leading-relaxed">
                    The Services may enable you to engage with third-party providers (e.g., domain registrars, payment gateways, third-party apps).
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">9.2. Liability</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">10.1. &quot;As Is&quot; Basis</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">10.2. No Guarantees</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">11.1. Limitation of Liability</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">11.2. Indemnity</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">12.1. Applicable Law</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">12.2. Exclusive Jurisdiction</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">13.1. Modifications</h3>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <LegalSection
            ...
            legalText={
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">14.1. Contact Details</h3>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">14.2. Resolution Timeline</h3>
                  <p className="text-gray-700 leading-relaxed">
