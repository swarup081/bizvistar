      ...
      <main className="flex-grow mt-10">
        <LegalLayout title="BizVistar Terms of Service" lastUpdated={new Date().toLocaleDateString('en-IN', { year: 'numeric', month: 'long', day: 'numeric' })}>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">1.1. Our Purpose</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">1.2. Legal Agreement</p>
                <p className="mb-4">
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">2.1. Age Requirements</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">2.2. Minor Prohibition</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">2.3. Sanctions and Location</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">3.1. Account Creation</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">3.2. Account Security</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">3.3. Account Ownership</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">4.1. General Compliance</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">4.2. Prohibited Actions</p>
                <p className="mb-2">You agree and undertake NOT to:</p>
                ...
                <p className="font-bold mb-2">4.3. Enforcement</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">5.1. Your Intellectual Property</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">5.2. License to BizVistar</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">5.3. BizVistar&apos;s Intellectual Property</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">6.1. E-Commerce Features</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">6.2. Your Responsibility</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">6.3. Payments and UPI</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">6.4. Taxes and Fulfilment</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">7.1. Paid Services</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">7.2. Strictly Non-Refundable</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">7.3. Auto-Renewals</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">7.4. Chargebacks</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">8.1. AI Integrations</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">8.2. Input and Output</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">8.3. Data Sharing</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">10.1. "As Is" Basis</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">10.2. No Guarantees</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">11.1. Limitation of Liability</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">11.2. Indemnity</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">12.1. Applicable Law</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">12.2. Exclusive Jurisdiction</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">13.1. Modifications</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">14.1. Contact Details</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">14.2. Resolution Timeline</p>
                <p>
