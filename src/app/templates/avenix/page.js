            ...
            <section id="home" className="py-24 bg-brand-primary overflow-hidden">
                <div className="container mx-auto px-6 max-w-screen-2xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative w-full max-w-lg h-64 md:h-96 mx-auto">
                            {/* Left half */}
               ...
               <Editable focusId="about">
                ...
                <Editable focusId="collection">
                    <section id="collection" className="py-24"> 
                        ...
                        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 items-start max-w-screen-2xl">
                            ...
                            {featuredProducts[0] && (
                                <div className="md:col-span-1 flex flex-col items-center text-center">
                                    <div className="bg-white rounded-2xl w-full"> 
                                        ...
                                        <p className="text-lg font-sans text-brand-text/80 mt-1">${featuredProducts[0].price.toFixed(2)} USD</p>
                                        <div className="flex flex-col sm:flex-row items-center gap-4 mt-6 pb-6 px-6">
                                            <Link href={`/templates/avenix/product/${featuredProducts[0].id}`} className="w-full btn-primary bg-brand-secondary text-brand-bg px-6 py-3 font-sans font-medium text-sm uppercase tracking-wider rounded-3xl text-center hover:opacity-80">Shop Now</Link>
                                            <Link href={`/templates/avenix/product/${featuredProducts[0].id}`} className="w-full btn-secondary bg-white text-brand-secondary border border-brand-text/20 px-6 py-3 font-sans font-medium text-sm uppercase tracking-wider rounded-3xl text-center hover:bg-gray-50">Learn More</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {featuredProducts[1] && (
                                <div className="md:col-span-1 flex flex-col items-center text-center">
                                    <div className="bg-white rounded-2xl w-full"> 
                                        ...
                                        <p className="text-lg font-sans text-brand-text/80 mt-1">${featuredProducts[1].price.toFixed(2)} USD</p>
                                        <div className="flex flex-col sm:flex-row items-center gap-4 mt-6  pb-6 px-6 ">
                                            <Link href={`/templates/avenix/product/${featuredProducts[1].id}`} className="w-full btn-primary bg-brand-secondary text-brand-bg px-6 py-3 font-sans font-medium text-sm uppercase tracking-wider rounded-3xl text-center hover:opacity-80">Shop Now</Link>
                                            <Link href={`/templates/avenix/product/${featuredProducts[1].id}`} className="w-full btn-secondary bg-white text-brand-secondary border border-brand-text/20 px-6 py-3 font-sans font-medium text-sm uppercase tracking-wider rounded-3xl text-center hover:bg-gray-50">Learn More</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
                ...
                <Editable focusId="cta">
                    <section id="cta" className="py-24 overflow-hidden">
                        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center max-w-screen-2xl">
                            <div className="text-left">
                                ...
                                <a href="/templates/avenix/shop" className="btn-primary inline-flex items-center gap-3 bg-brand-secondary text-brand-bg px-8 py-4 font-sans font-medium text-base uppercase tracking-wider rounded-full mt-10 hover:opacity-80">
                                    <span className="w-2.5 h-2.5 bg-white rounded-full"></span>
                ...
                <section className="py-24">
                    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 max-w-screen-2xl">
                        {businessData.features.map(feature => (
                            <div key={feature.title} className="p-10 bg-brand-primary rounded-2xl">
                                ...
                                {feature.cta && (
                                    <a href="/templates/avenix/shop" className="inline-block text-lg font-medium font-sans mt-8 hover:opacity-80">
                                        • {feature.cta}
                                    </a>
                                )}
                            </div>
                    ...
                    <section id="stats" className="py-24">
                        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center max-w-screen-2xl">
                            <div className="text-left">
                                ...
                                <a href="/templates/avenix/shop" className="inline-flex items-center gap-2 text-lg font-medium font-sans mt-8 hover:opacity-80">
