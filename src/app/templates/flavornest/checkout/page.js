    ...
    if (showUpi) {
        return (
            <div className="container mx-auto px-6 py-20 min-h-screen flex items-center justify-center">
                <div className="bg-brand-primary p-8 rounded-lg max-w-md w-full text-center shadow-lg">
                    ...
                    <h2 className="text-2xl font-serif font-bold text-brand-text mb-4">Order Successfully Placed!</h2>
