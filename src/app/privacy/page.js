      ...
      <main className="flex-grow mt-10">
        <LegalLayout title="Bizvistar Privacy Policy" lastUpdated={new Date().toLocaleDateString('en-IN', { year: 'numeric', month: 'long', day: 'numeric' })}>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">2.1. Information You Provide</p>
                <p className="mb-4">
                  When you register for an account, subscribe to our services, or contact our support team, we may collect Personal Information such as your name, email address, phone number, and billing information.
                </p>
                <p className="font-bold mb-2">2.2. Information We Collect Automatically</p>
                <p className="mb-4">
                  When you visit our website or use our Services, we may collect technical data such as your IP address, browser type, device information, and usage patterns to ensure our Services function properly and to improve user experience.
                </p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">3.1. Primary Uses</p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">4.1. Service Providers</p>
                <p className="mb-4">
                  We may share your Personal Information with trusted third-party service providers who assist us in operating our Services (e.g., hosting providers, payment processors, analytics tools). These providers are contractually obligated to protect your data.
                </p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">5.1. Security Practices</p>
                <p className="mb-4">
                  We implement reasonable physical, electronic, and procedural safeguards designed to protect your Personal Information. However, no method of transmission over the internet or electronic storage is 100% secure, and we cannot guarantee absolute security.
                </p>
                <p className="font-bold mb-2">5.2. Retention Policy</p>
                <p>
                  We will retain your Personal Information for as long as your account is active, or as needed to provide you with the Services. We may retain your information after account deactivation to comply with our legal obligations, resolve disputes, and enforce our agreements.
                </p>
              </>
            }
            plainEnglish={
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">6.1. Access and Deletion</p>
                <p className="mb-4">
                ...
                <p className="font-bold mb-2">6.2. Exercising Rights</p>
                <p>
          ...
          <LegalSection
            ...
            legalText={
              <>
                <p className="font-bold mb-2">7.1. Officer Details</p>
                <p className="mb-4">
